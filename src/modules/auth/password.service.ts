...
export class PasswordService {
	...
	async individualForgotPasswordRequest(payload: ForgotPasswordInput) {
		try {
	...
	async individualForgotPasswordVerify(payload: ForgotPasswordVerifyInput) {
	...
	async individualChangePassword(payload: ChangePasswordInput) {
		try {
